...
mkdir /data1/mloc/local/runs/r0_features.5mins.all_historical/10ptwin.2hour_shift

cd /data1/mloc/src/

exec 2>&1 | tee /data1/mloc/local/runs/r0_features.5mins.all_historical/10ptwin.2hour_shift/run.log
