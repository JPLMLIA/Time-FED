...
#     warning = lambda s: print(s),
#     info    = lambda s: print(s),
...
def roll(df, case):
    ...
    case: str
        The case of this run: either r0 or pwv
...
if __name__ == '__main__':
    ...
    parser.add_argument('case',                 type     = str,
                                                ...
                                                help     = 'The kind of run this is (either r0 or pwv)'
    )
...
- pwv: With cadence = 30, to forecast 3 hours do 180/30 = 6
- pwv: With cadence = 60, to forecast 3 hours do 180/60 = 2
Defaults to 3 hours for any cadence in either case.\
'''
    )
